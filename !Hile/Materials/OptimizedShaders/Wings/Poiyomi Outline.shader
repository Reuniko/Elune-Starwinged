Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/7d51c7293e6292d4a916aee513e0fefd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalMaskChannel 					 = (1.0 /*_Decal0MaskChannel*/);
				...
				Decal3.m_DecalMaskChannel 					 = (2.0 /*_Decal3MaskChannel*/);
