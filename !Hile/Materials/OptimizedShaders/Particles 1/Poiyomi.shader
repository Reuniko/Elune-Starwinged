Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/1ab19b4b4ddfd4a439e966e4097760d6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (50.0 /*_GlitterFrequency*/);
				...
				glitterColor *= lerp(1, poiFragData.baseColor, (0.528 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (5.3 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((5.3 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (5.3 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
