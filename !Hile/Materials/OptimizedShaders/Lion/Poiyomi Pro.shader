Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/b4c77b2e8ab980a439fb7108c020c688"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_Lion ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_Saturation_Lion ("Saturation", Range(-1, 10)) = 0
		...
		_MainHueShift_Lion ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_Lion ("Hue Shift", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MainHueShift_Lion;
			float _MainHueShiftSpeed;
			float _Saturation_Lion;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_Lion;
					#ifdef POI_AUDIOLINK
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -(_Saturation_Lion) * hueShiftAlpha.b);
