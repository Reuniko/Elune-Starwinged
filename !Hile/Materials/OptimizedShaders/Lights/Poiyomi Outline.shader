Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/8263c4c349674304f9427e69de5ff5c3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.134 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.706 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(10,0,0,0).xyz) * (1.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (0.5 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(10,0,0,0).xyz, (0.5 /*_EmissiveScroll_Velocity*/), (1.0 /*_EmissiveScroll_Interval*/), (80.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
				if (_EmissionBlinkingEnabled)
				{
					emissionStrength0 *= calculateBlinkingEmission((0.2 /*_EmissiveBlink_Min*/), (2.5 /*_EmissiveBlink_Max*/), (4.0 /*_EmissiveBlink_Velocity*/), (5.0 /*_EmissionBlinkingOffset*/));
				}
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (0.55 /*_EmissionStrength1*/);
				float glowInTheDarkMultiplier1 = calculateGlowInTheDark((0.0 /*_GITDEMinLight1*/), (1.0 /*_GITDEMaxLight1*/), (1.0 /*_GITDEMinEmissionMultiplier1*/), (0.565 /*_GITDEMaxEmissionMultiplier1*/), (1.0 /*_EnableGITDEmission1*/), (0.0 /*_GITDEWorldOrMesh1*/), poiLight);
				#if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(1,0,0,0).xy * _Time.x) * (100.0 /*_GlitterFrequency*/);
				...
				switch((0.0 /*_GlitterShape*/))
				{
					...
					if ((1.0 /*_GlitterRandomRotation*/) == 1 || (0.0 /*_GlitterTextureRotation*/) != 0)
					{
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (18.5 /*_GlitterAngleRange*/), (10.0 /*_GlitterSpeed*/));
					}
					else
					{
						randomRotation = randomFloat3Range(randoPoint, (18.5 /*_GlitterAngleRange*/));
					}
					float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.8 /*_GlitterBias*/)), poiCam.viewDir)), (675.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (675.0 /*_GlitterContrast*/)), 0);
				...
				if ((1.0 /*_GlitterRandomRotation*/) == 1 || (0.0 /*_GlitterTextureRotation*/) != 0 && !(0.0 /*_GlitterShape*/))
				{
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (6.2 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((6.2 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (6.2 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.748 /*_MochieMetallicMultiplier*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.5152035,0.5152035,0.5152035,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.5152035,0.5152035,0.5152035,1).a);
				if ((1.0 /*_OutlineExpansionMode*/) == 2)
				{
