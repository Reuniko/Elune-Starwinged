Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/b529ba4e933d14f418a72a52efee7a54"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				if ((1.0 /*_AlphaDithering*/))
				{
					...
					poiFragData.alpha = saturate(poiFragData.alpha - (dither * (1 - poiFragData.alpha) * (0.898 /*_AlphaDitherGradient*/)));
				}
			}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, _MatcapColor.rgb, (0.0 /*_MatcapColorThemeIndex*/)), _MatcapColor.a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, _MatcapColor.rgb, (0.0 /*_MatcapColorThemeIndex*/)), _MatcapColor.a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, _MatcapColor.rgb, (0.0 /*_MatcapColorThemeIndex*/)), _MatcapColor.a);
				#endif
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.33 /*_EmissionStrength*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor = lerp(col, col * poiFragData.baseColor * lerp(1, poiFragData.baseColor, (0.0 /*_PoiUTSStyleOutlineBlend*/)), (0.703 /*_OutlineTintMix*/));
				if (_OutlineHueShift)
				{
